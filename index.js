...
console.log('reached get');   
    ...
    var jsonreq = {client_id: "c6f36595-cad5-4861-8dd7-b6849cab70bd",scope:"mail.read",code:req.query.code,client_secret:"X5gnN89guhOP6v6eyubQXwP",redirect_uri:"https://emailaccess.herokuapp.com",grant_type:"authorization_code"};
    console.log(jsonreq);
    httpreq({
